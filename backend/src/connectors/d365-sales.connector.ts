      ...
      const kpis = [
        {
          ...
          trend: 'up' as const,
          trend_pct: 5.2,
          status: totalTcv >= 60000000 ? 'on_track' as const : 'at_risk' as const,
          source: this.name,
          period: 'QTD',
        ...
        },
        {
          ...
          target: 60000000,
          unit: 'AED',
          status: weightedPipeline >= 60000000 ? 'on_track' as const : 'at_risk' as const,
          source: this.name,
          period: 'QTD',
          as_of_date: new Date().toISOString().split('T')[0],
        },
        {
          ...
          target: 40,
          unit: '%',
          status: avgWinProbability >= 40 ? 'on_track' as const : 'at_risk' as const,
          source: this.name,
          period: 'QTD',
          as_of_date: new Date().toISOString().split('T')[0],
        },
